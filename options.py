...
parser.add_argument('--template', type=str, default='train_bertls_clustered')
...
parser.add_argument('--loss_names', nargs='+', type=str, default=['loss'], help='names of losses for model')
# evaluation #
