...
def set_template(args):
    ...
    if args.template is None:
        ...
        args.ae_input_dim = args.bert_hidden_units
        args.ae_hidden_dims = [500, 500, 2000]
        args.ae_latent_dim = 10

    elif args.template.startswith('train_bertls_base'):
        args.mode = 'train'
        args.rated = False
